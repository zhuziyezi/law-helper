...
export default async function handler(req: NextRequest) {
  try {
    ...
    const moderationResponse = await fetch('https://api.glm-ai.com/v1/moderations', {
      method: 'POST',
      headers: {
    ...
    const embeddingResponse = await fetch('https://api.glm-ai.com/v1/embeddings', {
      method: 'POST',
      headers: {
        Authorization: `Bearer ${openAiKey}`,
        'Content-Type': 'application/json',
    ...
    const response = await fetch('https://api.glm-ai.com/v1/chat/completions', {
      method: 'POST',
      headers: {
        Authorization: `Bearer ${openAiKey}`,
        'Content-Type': 'application/json',
